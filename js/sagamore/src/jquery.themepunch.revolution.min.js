...
(function (e, t) {
    ...
    var v = function (t, n) {
        ...
        var b = n.navigationVAlign, w = n.navigationHAlign, E = n.navigationVOffset, S = n.navigationHOffset;
    ...
    var q = function (e, n) {
        ...
        if (!e.hasClass("tp-splitted")) {
            ...
            var lineSize = Math.round(e.data("fsize") * n.bw) < 14 ? 14: Math.round(e.data("fsize") * n.bw);
            var lineNum = 1;
            var marginTopSize = 0;
            if(e.hasClass("revelance-big")){
                if(e.height() % 80 === 0){
                    lineNum = Math.round(e.height() / 80);
                    marginTopSize = -((lineNum-1) * lineSize);
                }
                else{
                    lineNum = Math.round(e.height() / lineSize);
                    marginTopSize = -((lineNum-1) * lineSize);
                }
            }
